...
import { Dialog, DialogDescription, DialogTitle } from "@headlessui/react"; // or any other modal library
          ...
          <form className="p-4" onSubmit={formik.handleSubmit}>
            ...
            <div className="mb-8">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-6">
                ...
                {/* Date of Birth */}
                <div>
                  <label htmlFor="dob" className="block text-md font-semibold">
                    Date of Birth
                  </label>
                  <DatePicker
                    id="dob"
                  ...
                  {formik.touched.dob && formik.errors.dob ? (
                    <div className="flex items-center mt-2 gap-2 text-red-600 font-medium">
                      ...
                      <span>{formik.errors.dob.toString()}</span>
                    </div>
                  ) : null}
                </div>
                {/* Gender */}
                <div>
                  ...
                  {formik.touched.gender && formik.errors.gender ? (
                    <div className="flex items-center mt-2 gap-2 text-red-600 font-medium">
                      ...
                      <span>{formik.errors.gender.toString()}</span>
                    </div>
                  ) : null}
                </div>
              </div>
                ...
                <div>
                  ...
                  formik.errors.secondaryNumber ? (
                    <div className="flex items-center mt-2 gap-2 text-red-600 font-medium">
                      ...
                      <span>{formik.errors.secondaryNumber.toString()}</span>
                    </div>
                  ) : null}
                </div>
                {/* LinkedIn */}
                <div>
                  ...
                  {formik.touched.linkedin && formik.errors.linkedin ? (
                    <div className="flex items-center mt-2 gap-2 text-red-600 font-medium">
                      ...
                      <span>{formik.errors.linkedin.toString()}</span>
                    </div>
                  ) : null}
                </div>
              </div>
            ...
            <div className="mb-8">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                ...
                <div className="space-y-4">
                  <label htmlFor="isActive" className="font-semibold text-md">
                    Candidate Status
                  </label>
                      ...
                      {[true, false].map((option, i) => (
                        ...
                        >
                          <input
                            type="radio"
                            name="salary_nego"
                            value={formik.values.isExpectedCtcNegotiable}
                            onChange={() =>
                          ...
                          <div
                            className={`w-5 h-5 rounded-full border-2 flex items-center justify-center ${
                              formik.values.isExpectedCtcNegotiable === option
                                ? "border-cyan-500"
                                : "border-gray-300"
                            }`}
                          >
                            {formik.values.isExpectedCtcNegotiable ===
                              option && (
                              <div className="w-3 h-3 rounded-full bg-cyan-500"></div>
                            )}
                          </div>
                ...
                <div className="lg:col-span-2 space-y-4">
                  ...
                  <div className="flex flex-wrap gap-4">
                    {["Onsite", "Remote", "Hybrid", "Flexible"].map(
                      (option) => {
                        const isChecked =
                          option === "Onsite"
                            ? isOnsite ||
                            ...
                            : isFlexible || (isHybrid && isRemote && isOnsite);
                        return (
                          <label
                            key={option}
                            className="flex items-center gap-2 cursor-pointer"
                          >
                            <input
                              type="checkbox"
                              value={option}
                              name={`preferredJobType_${option}`}
                              id={`preferredJobType_${option}`}
                              onChange={(e) => handleJobTypeBoxCheck(e, option)}
                              checked={isChecked}
                              className="sr-only"
                            />
                            <div
                        ...
                        return (
                          ...
                          >
                            <input
                              type="checkbox"
                              value={option}
                              name={`preferredHiringType_${option.replace(
                                /\s+/g,
                                ""
                              )}`}
                              id={`preferredHiringType_${option.replace(
                                /\s+/g,
                                ""
                              )}`}
                              onChange={(e) =>
                                handleHiringTypeBoxCheck(e, option)
                              }
                              checked={isChecked}
                              className="sr-only"
                            />
            ...
            <div className="mb-8">
              ...
              <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
                ...
                <div className="space-y-1">
                  <label htmlFor="address1" className="text-md font-semibold">
                    Address
                  </label>
                  <input
                    id="address1"
                  ...
                  {formik.touched.address1 && formik.errors.address1 ? (
                    <div className="flex items-center mt-2 gap-2 text-red-600 font-medium">
                      ...
                      <span>{formik.errors.address1.toString()}</span>
                    </div>
                  ) : null}
                </div>
                <div className="space-y-1">
                  ...
                  formik.errors.addressLocality ? (
                    <div className="flex items-center mt-2 gap-2 text-red-600 font-medium">
                      ...
                      <span>{formik.errors.addressLocality.toString()}</span>
                    </div>
                  ) : null}
                </div>
                {/* Row 3 */}
                <div className="space-y-1">
                  <label htmlFor="pinCode" className="text-md font-semibold">
                    Pincode
                  </label>
                  <input
                    id="pinCode"
                ...
                <div className="space-y-1">
                  ...
                  formik.errors.maritalStatus ? (
                    <div className="flex items-center mt-2 gap-2 text-red-600 font-medium">
                      ...
                      <span>{formik.errors.maritalStatus.toString()}</span>
                    </div>
                  ) : null}
                </div>
                {/* Row 4 */}
                <div className="space-y-4">
                      ...
                      {[true, false].map((status, index) => (
                        ...
                        >
                          <input
                            ...
                            value={formik.values.differentlyAbled}
                            onChange={() => {
                              setIsDifferentlyAbleEnabled(status);
                              formik.setFieldValue("differentlyAbled", status);
                            }}
                            className="sr-only"
                          />
                          <div
                            className={`w-5 h-5 rounded-full border-2 flex items-center justify-center ${
                              formik.values.differentlyAbled === status || null
                                ? "border-cyan-500"
                                : "border-gray-300"
                            }`}
                          >
                            {formik.values.differentlyAbled === status ||
                            null ? (
                              <div className="w-3 h-3 rounded-full bg-cyan-500"></div>
                            ) : null}
                          </div>
                  ...
                  formik.errors.differentlyAbled ? (
                    <div className="flex items-center mt-2 gap-2 text-red-600 font-medium">
                      ...
                      <span>{formik.errors.differentlyAbled.toString()}</span>
                    </div>
                  ) : null}
                </div>
                {/* Differently Abled Type - Conditional */}
                {(isDifferentlyAbleEnabled ||
                  formik.values.differentlyAbled) && (
                  <div className="space-y-1">
                    <label
